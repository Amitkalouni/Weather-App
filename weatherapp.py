...
API_KEY = "0257953c4a3119ead1a8428dcb5e88d9"
...
st.markdown("<div class='main-title'>🌥️ My Weather App</div>", unsafe_allow_html=True)
...
if city:
    ...
    if data.get("cod") == 200:
        ...
        st.markdown(f"<p class='metric'>☁ {weather['description'].title()}</p>", unsafe_allow_html=True)
...
st.markdown("<div class='footer'>Powered by OpenWeatherMap API | Built with ❤ using Streamlit</div>", unsafe_allow_html=True)